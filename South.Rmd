...
# census_detail
west_cd <- read_excel("data/Copy of nbhd_South Dallas - Combined_v9.xlsx", sheet = "census_detail")
# census_hh_inc
west_chi <- read_excel("data/Copy of nbhd_South Dallas - Combined_v9.xlsx", sheet = "census_hh_inc")
# land_use_by_year
west_lu <- read_excel("data/Copy of nbhd_South Dallas - Combined_v9.xlsx", sheet = "land_use_by_year")
# unit_counts_by_type
west_uc <- read_excel("data/Copy of nbhd_South Dallas - Combined_v9.xlsx", sheet = "unit_counts_by_type")
# median_sales_mls
west_msm <- read_excel("data/Copy of nbhd_South Dallas - Combined_v9.xlsx", sheet = "median_sales_mls")
```
...
```{r echo = FALSE, message=FALSE, warning=FALSE, fig.width=13,fig.height=7, layout="l-body-outset"}
west_cd$iflation <- c(0.124, 0.054, 0.034, 0.0316, 0.083)
west_cd$median_gross_rent_adj_inflation_adjusted <- west_cd$median_gross_rent_adj - west_cd$median_gross_rent_adj*west_cd$iflation
